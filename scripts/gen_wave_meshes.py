...
def check_output_directory(output_directory):
    """
    Checks whether the inputted output directory for the .vtu files
    exists, creates the directory if it doesn't and asks to overwrite
    data if it does.

    :param output_directory: output directory for function to check.
    :returns: None 
    """
